...
export const newsletterData = {
  ...
  description: "Subscribe to receive invitations to private events and the latest innovations in aesthetics and wellness.",
  inputPlaceholder: "YOUR EMAIL",
  buttonText: "SUBSCRIBE"
};

export const instagramData = {
  handle: "@sculptbodyspa_",
  profileLink: "https://www.instagram.com/sculptbodyspa_?utm_source=qr",
  description: "Discover our treatments, real results, and wellness tips directly from our profile.",
  posts: [
    {
      id: 1,
      image: "/images/instagram/1.webp",
      text: "Discover the power of our facial treatments for radiant and rejuvenated skin.",
      link: "https://www.instagram.com/p/DLVec_DOCm9/",
    },
    {
      id: 2,
      image: "/images/instagram/2.webp",
      text: "Relax and renew your energy with our full-body therapeutic massages.",
      link: "https://www.instagram.com/p/DNf_IPbONUG/",
    },
    {
      id: 3,
      image: "/images/instagram/3.webp",
      text: "Incredible results with our non-invasive body contouring technology.",
      link: "https://www.instagram.com/p/DOd75sxjvNE/?img_index=1",
    },
    {
      id: 4,
      image: "/images/instagram/4.webp",
      text: "Prepping the skin for a deep cleanse. Your face deserves the best care.",
      link: "https://www.instagram.com/p/DPjS0rmjhC0/?img_index=1",
    },
    {
      id: 5,
      image: "/images/instagram/5.webp",
      text: "Total transformation and mental well-being in an environment designed for your inner peace.",
      link: "https://www.instagram.com/p/DPwObkFDjP_/?img_index=1",
    },
    {
      id: 6,
      image: "/images/instagram/6.webp",
      text: "Aesthetic equipment session and reductive massages to tone and effectively reduce measurements.",
      link: "https://www.instagram.com/p/DSSa2k5jpFD/?img_index=1",
    },
    {
      id: 7,
      image: "/images/instagram/7.webp",
      text: "Facial harmonization with incredible aesthetic results. Enhance your unique beauty.",
      link: "https://www.instagram.com/p/DTa4-C6kf_l/?img_index=3",
    },
    {
      id: 8,
      image: "/images/instagram/8.webp",
      text: "Our spaces are created to provide you with maximum tranquility during your visit.",
      link: "https://www.instagram.com/p/DTa4-C6kf_l/?img_index=1",
    },
    {
      id: 9,
      image: "/images/instagram/9.webp",
      text: "Personalized treatments and top-quality care to achieve your wellness goals.",
      link: "https://www.instagram.com/p/DTa4-C6kf_l/?img_index=2",
    },
    {
      id: 10,
      image: "/images/instagram/10.webp",
      text: "A true oasis of relaxation in the city. Come enjoy your spa day.",
      link: "https://www.instagram.com/p/DTfs2F2kbKM/?img_index=1",
    },
    {
      id: 11,
      image: "/images/instagram/11.webp",
      text: "Specialized skincare with luxury products to restore its natural glow.",
      link: "https://www.instagram.com/p/DTx-qpUEbXZ/?img_index=1",
    },
    {
      id: 12,
      image: "/images/instagram/12.webp",
      text: "Before and after our star Sculpt treatment. The results speak for themselves!",
